...
<html>
	...
	<body>
		<a href="#create-igreja" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-igreja" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:igrejaInstance, action:'save']" >
				<fieldset class="form">
